...
- (UITableViewCell *)initCellWithIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *label = [[[UILabel alloc] initWithFrame:CGRectMake(65, 4, 230, 20)] autorelease];
    ...
    UILabel *label2 = [[[UILabel alloc] initWithFrame:CGRectMake(65, 26, 230, 14)] autorelease];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (section == 0)
    {
        if (row == 0)
        {
            [socila sendEmail:NSLocalizedString(@"ColorEmoji", nil) body:NSLocalizedString(@"invite", nil) recipient:nil];
        }
        else if (row == 1)
        {
        ...
        {
            [socila sendFeedback:NSLocalizedString(@"ColorEmoji", nil) body:nil];
        }
        else
        {
